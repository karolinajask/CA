...
1. Registered users’ information management: The system should be able to store and manage registered users’ records, including personal details, 
search history, viewed ads and the ads added by them.
...
5. Transaction management: The system should be able to allow registered users to transact with each other, using Stripe API and perform basic verification of transaction details.
